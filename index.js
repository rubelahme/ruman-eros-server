...
const uri =
  "mongodb+srv://Rubel:pVyqQKPBx8auCtKM@cluster0.l479m.mongodb.net/Ruman?retryWrites=true&w=majority";
...
client.connect((err) => {
  const collection = client.db("Ruman").collection("Eros");
  const collections = client.db("Ruman").collection("Topuimage");
  const ImageCollection = client.db("Ruman").collection("TopuNewImage");
